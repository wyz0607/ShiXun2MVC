...
namespace Restaurant_Information_MVC.Controllers
{
    public class WorkController : Controller
    {
        ...
        //[HttpPost]
        //public string Duanxin(string phone = "17321446954")
        //{

        //    //UTF-8格式：   String encode="UTF-8"
        //    String encode = "UTF-8";  //页面编码和短信内容编码为GBK。重要说明：如提交短信后收到乱码，请将GBK改为UTF-8测试。如本程序页面为编码格式为：ASCII/GB2312/GBK则该处为GBK。如本页面编码为UTF-8或需要支持繁体，阿拉伯文等Unicode，请将此处写为：UTF
        //    String username = "17321446954";  //用户名
        //    String password_md5 = "snw123456";  ////32位MD5密码加密，不区分大小写
        //    String mobile = $"{phone}";  //手机号,只发一个号码：13800000001。发多个号码：13800000001,13800000002,...N 。使用半角逗号分隔。
        //    String apikey = "bfc73bab25ba0a15509494cfecdaf0d8";  //apikey秘钥（请登录 http://m.5c.com.cn 短信平台-->账号管理-->我的信息 中复制apikey）
        //    string content = "您好！您的验证码是：1234【美联】";  //要发送的短信内容，特别注意：签名必须设置，网页验证码应用需要加添加【图形识别码】。;
        ...
        //    sbTemp.Append("username=" + username + "&password_md5=" + password_md5 + "&mobile=" + mobile + "&apikey=" + apikey + "&content=" + content2 + "&encode=" + encode);
        ...
        //    return (sb.ToString());
        //}
        //private static string WriteErrLog(string strErr)
        //{
        ...
        public string SendEmail(string email)
        {
            ...
            e.Send();
            //Session["Yanzhengma"] = validateCode;
            //ViewBag.yanzheng = validateCode;
            //Yanzheng = validateCode;
